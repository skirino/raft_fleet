...
defmodule RaftFleet.Config do
  ...
  - `:balancing_interval`
      ...
      - The actual value used is obtained by `Application.get_env(:raft_fleet, :balancing_interval, 300_000)`,
        i.e. it defaults to 5 minutes.
  ...
  - `:node_purge_failure_time_window`
      ...
      - The actual value used is obtained by `Application.get_env(:raft_fleet, :node_purge_failure_time_window, 900_000)`,
        i.e. it defaults to 15 minutes.
  """

  @default_balancing_interval (if Mix.env == :test, do: 1_000, else: 300_000)
  ...
  @default_node_purge_failure_time_window (if Mix.env == :test, do: 5_000, else: 900_000)
